...
insert into product values(1,'Shampoo',550.50,800,'10/12/2022','10/12/2024')
...
@expdate date
as
insert into Products(PId,PName,PPrice,PQuantity,PQuantity,PExpdate) values(@id,@name,@price,@qty,@mfgdate,@expdate)
